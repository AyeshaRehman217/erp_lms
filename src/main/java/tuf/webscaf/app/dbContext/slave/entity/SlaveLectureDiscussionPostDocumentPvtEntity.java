...
@NoArgsConstructor
@AllArgsConstructor
@Table("lms.\"lecture_discussion_post_document_pvt\"")
public class SlaveLectureDiscussionPostDocumentPvtEntity {
    ...
    @Column("lecture_discussion_post_uuid")
    private UUID lectureDiscussionPostUUID;
