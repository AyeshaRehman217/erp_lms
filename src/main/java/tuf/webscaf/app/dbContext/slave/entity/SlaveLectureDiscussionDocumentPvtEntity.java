...
@NoArgsConstructor
@AllArgsConstructor
@Table("lms.\"lecture_discussion_document_pvt\"")
public class SlaveLectureDiscussionDocumentPvtEntity {
    ...
    @Column("lecture_discussion_uuid")
    @Schema(required = true)
    private UUID lectureDiscussionUUID;
