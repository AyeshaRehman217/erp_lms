package tuf.webscaf.app.dbContext.slave.entity;//package tuf.webscaf.app.dbContext.master.entity;
...
@NoArgsConstructor
@AllArgsConstructor
@Table("lms.\"assignment_attempt_marks\"")
public class SlaveAssignmentAttemptMarksEntity {
    ...
    @Column("assignment_attempt_uuid")
